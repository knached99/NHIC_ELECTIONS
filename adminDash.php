    ...
    <nav class="side-navbar">
      <div class="side-navbar-wrapper">
        ...
        <div class="sidenav-header d-flex align-items-center justify-content-center">
          <!-- User Info-->
          <div class="sidenav-header-inner text-center"><img src="<?php echo $profile_img;?>" alt="Admin" class="img-fluid rounded-circle">
            <p class="h5"><?php echo $displayMessage .' , '.$firstName;?></p><span><?php echo $username;?></span>
          </div>
    ...
    -->
        ...
        <div class="container-fluid">
          <div class="row d-flex">
            ...
            <div class="col-lg-4">
              <!-- Income-->
              <div class="card income text-center bg-light shadow-lg p-3 mb-5 bg-light rounded">
                <div class="icon"><i class="fa fa-calendar text-lead"></i></div>
                <div class="number text-dark" style="font-weight: 700;">Today's Date</div><strong class="text-success"><?php echo DATE("F jS, Y");?></strong>
              </div>
            </div>
            <!--
            <div class="col-lg-4">
          ...
          -->
            <div class="col-lg-4">
              ...
              <div class="card user-activity bg-light shadow-lg p-3 mb-5 bg-light rounded">
                <h2 class="display h4 text-black font-weight-bold">All NHIC Members</h2>
                <i class="fa fa-database fa-3x text-lead"></i><br>
                <div class="number"></div>
                <h3 class="h4 display text-dark">When viewing NHIC members, you can <b style="color:#02b9bf;">Search</b> for a member,<b style="color:#db6300;">edit</b> their info, <b style="color: #f54242;">delete</b> a member, or <b style="color: #00cf8a;">add</b> a new member</h3>
                <!--<div class="progress">
                    ...
                    <ul class="feed-elements list-unstyled">
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="assets/avatar-5.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="assets/avatar-2.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="assets/avatar-3.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="assets/avatar-1.jpg" alt="person" class="img-fluid rounded-circle"></a>
                      ...
                      <li class="clearfix">
                        <div class="feed d-flex justify-content-between">
                          <div class="feed-body d-flex justify-content-between"><a href="#" class="feed-profile"><img src="assets/avatar-6.jpg" alt="person" class="img-fluid rounded-circle"></a>
      ...
      <footer class="main-footer">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <p class="text-success">New Haven Islamic Center &copy; 1983-<?php echo DATE('Y');?></p>
            </div>
