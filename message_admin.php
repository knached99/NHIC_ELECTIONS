          ...
          <div class="row d-flex">
            <div class="col-sm-4">
              ...
              <select name="subject" class="form-control">
                <option value="no subject">No Subject Selected</option>
                <option value="General Inquiry">General Inquiry</option>
                <option value="Addressing Bugs">Addressing Bugs</option>
                <option value="Report a member">Report a member</option>
                <option value="Incident Occurrance">Incident Occurrance</option>
              </select>
              </div>
              <div class="col-sm-4">
                <label class="form-label font-weight-bold">Write a brief message</label>
                <textarea class="form-control" cols="5" name="message">
                </textarea>
              </div>
            </div>
            <div class="row d-flex mt-4 ml-4">
              <button class="btn btn-primary font-weight-bold" name="sendMessage">Send Message</button>
            </div>
          </div>
        </div>
        </form>
